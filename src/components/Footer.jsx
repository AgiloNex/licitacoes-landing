...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    empresa: [
      ...
      { label: 'Imprensa', href: '#' },
      { label: 'Contato', href: 'mailto:contato@licitai.com.br' },
    ],
    recursos: [
    ...
    legal: [
      ...
      { label: 'LGPD', href: '#' },
      { label: 'Contrato de processamento', href: '#' },
    ],
  }
      ...
      <div className="section-container py-12 lg:py-16">
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4" aria-label="LicitAI - Página inicial">
            ...
            <p className="text-slate-600 text-sm max-w-xs mb-6">
              Inteligência de dados para empresas que vendem para o governo. Encontre editais, analise concorrentes e gere propostas vencedoras.
            </p>
            <div className="flex gap-4">
              <a href="#" className="text-slate-400 hover:text-primary-600 transition-colors" aria-label="LinkedIn">
              ...
              <a href="#" className="text-slate-400 hover:text-primary-600 transition-colors" aria-label="YouTube">
              ...
              <a href="#" className="text-slate-400 hover:text-primary-600 transition-colors" aria-label="Instagram">
          ...
          <nav aria-label="Produto">
            ...
            <ul className="space-y-3" role="list">
              {footerLinks.produto.map((link, index) => (
                <li key={index}>
                  <Link href={link.href} className="text-sm text-slate-600 hover:text-primary-600 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">
            © {currentYear} LicitAI. Todos os direitos reservados.
          </p>
          <p className="text-sm text-slate-500">
